  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <?php echo $__env->make('components.layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- End of Topbar -->
...
</html><?php /**PATH C:\Users\Kaiserr\Desktop\baranggay1\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>